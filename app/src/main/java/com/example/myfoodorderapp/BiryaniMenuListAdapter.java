...
public class BiryaniMenuListAdapter extends RecyclerView.Adapter<BiryaniMenuListAdapter.MyViewHolder> {
    List<MenuList> menuList;
    Context context;
    public BiryaniMenuListAdapter(List<MenuList> menuList, Context context){
    ...
    @NonNull
    @Override
    public BiryaniMenuListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.card_layout,parent,false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BiryaniMenuListAdapter.MyViewHolder holder, int position) {
