...
public class PizzaActivity extends AppCompatActivity {
    ...
    String jsonUrl="https://asterisc.in/priyanka/FoodOrderApp/pizza_menu.json";
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.GET, jsonUrl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    JSONArray MenuArray = jsonObject.getJSONArray("pizza");
    ...
    private void initRecyclerView(){
        ...
        PizzaMenuListAdapter adapter=new PizzaMenuListAdapter(menuList,this);
