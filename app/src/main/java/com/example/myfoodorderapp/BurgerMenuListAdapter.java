...
public class BurgerMenuListAdapter extends RecyclerView.Adapter<BurgerMenuListAdapter.MyViewHolder> {
    List<MenuList> menuList;
    Context context;

    public BurgerMenuListAdapter(List<MenuList> menuList, Context context) {
    ...
    @NonNull
    @Override
    public BurgerMenuListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.card_layout,parent,false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BurgerMenuListAdapter.MyViewHolder holder, int position) {
