...
public class PizzaMenuListAdapter extends RecyclerView.Adapter<PizzaMenuListAdapter.MyViewHolder>{
    List<MenuList> menuList;
    Context context;

    public PizzaMenuListAdapter(List<MenuList> menuList, Context context) {
    ...
    @NonNull
    @Override
    public PizzaMenuListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.card_layout,parent,false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PizzaMenuListAdapter. MyViewHolder holder, int position) {
