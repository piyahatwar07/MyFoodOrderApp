...
public class BurgerActivity extends AppCompatActivity {
    ...
    String jsonUrl="https://asterisc.in/priyanka/FoodOrderApp/burger_menu.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(BurgerActivity.this, MainActivity.class);
                startActivity(i);
                finish();
            }
        });
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.GET, jsonUrl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    JSONArray MenuArray = jsonObject.getJSONArray("burger");
    ...
    private void initRecyclerView(){
        ...
        BurgerMenuListAdapter adapter=new BurgerMenuListAdapter(menuList,this);
